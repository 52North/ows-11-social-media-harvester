...
public class TemplateUtil {
	...
	public static String fillTemplate(String templateFileName, Map<String, String> values) {
		...
		for (String key : values.keySet()) {
			...
			template = template.replace(String.format("${%s}", key), value != null ? value : "not_available");
		}
	...
	public static String readContents(String templateFileName) {
		...
		Scanner sc = new Scanner(TemplateUtil.class.getResourceAsStream(templateFileName));
		while (sc.hasNext()) {
